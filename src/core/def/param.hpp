class Params {
    ...
    class btc_p_arsenal_Presets { // Arsenal/loadout preset mode
        title    = __EVAL(format ["      %1", localize "STR_BTC_HAM_PARAM_ARSENAL_ARSENALPRESETS"]);
        values[] = {0};
        texts[]  = {$STR_BTC_HAM_PARAM_ARSENAL_ARSENALPRESETS_RHSUSAF};
        default  = 0;
    };
